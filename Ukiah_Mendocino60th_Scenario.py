# -*- coding: utf-8 -*-
"""
Created on Wed Jan  4 20:31:30 2023
...
model_name = 'Flopy_Outputs_Medno_60th\\Ukiah'
...
#### 1965 Hist
segment_data = pd.read_csv('Input_Data\\SFR_New\\With_Diversion\\SI_1991-2018_Scenario_Medno_60th.csv')
...
for i in range(strt_rech,end_rech):
    rech_dict[i] = np.loadtxt('Input_Data\\Recharge_MAR\\Scenario6\\Rech_MAR_'+str(i+312)+'.asc')
