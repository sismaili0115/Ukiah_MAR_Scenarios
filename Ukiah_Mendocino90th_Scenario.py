...
model_name = 'Flopy_Outputs_Medno\\Ukiah'
...
segment_data = pd.read_csv('Input_Data\\SFR_New\\With_Diversion\\SI_1991-2018_Scenario_Medno_90th.csv')
...
for i in range(strt_rech,end_rech):
    rech_dict[i] = np.loadtxt('Input_Data\\Recharge_MAR\\Scenario5\\Rech_MAR_'+str(i+312)+'.asc')
