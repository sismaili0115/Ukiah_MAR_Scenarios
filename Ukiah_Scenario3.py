...
model_name = 'Flopy_Output_Scenario3\\Ukiah'
...
#### 1965 Hist
segment_data = pd.read_csv('Input_Data\\SFR_New\\With_Diversion\\SI_1991-2018_Scenario3.csv')
...
for i in range(strt_rech,end_rech):
    rech_dict[i] = np.loadtxt('Input_Data\\Recharge_MAR\\Scenario3\\Rech_MAR_'+str(i+312)+'.asc')
